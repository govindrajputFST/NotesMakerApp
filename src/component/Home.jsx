        ...
        <div>
            ...
            <div className={Style.BigBox}>
                <div className={Style.SideBox}>
                    ...
                    <button onClick={reopenNotes} className={Style.searchhhh}><i class="fa-solid fa-xmark"></i></button>
                ...
                <div className={Style.Textbox}>
                    <form  >
                        ...
                        <button type='submit' className={Style.btn} onClick={handleSubmit}>Save</button>
                        ...
                        <button onClick={genratePDF} className={Style.bt}><i class="fa-solid fa-download"></i>Download</button>
                    </form>
